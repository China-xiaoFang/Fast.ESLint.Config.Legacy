...
import { createJavaScriptConfig } from "./javascript";
import { type TypeScriptConfigOptions, createTypeScriptConfig } from "./typescript";
 ...
 *
 * 公开 `/react` 预置使用 automatic JSX runtime 和 React 版本自动检测。项目如需覆盖
