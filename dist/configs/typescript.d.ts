...
/** 可直接用于 Legacy `extends` 的非类型感知 TypeScript 配置。 */
declare const config: Linter.Config;
//#endregion
export { TypeAwareOptions, TypeScriptConfigOptions, createTypeAwareConfigs, createTypeScriptConfig, createTypeScriptConfigs, createTypeScriptDeclarationConfigs, createTypeScriptExtends, createTypeScriptParserOptions, config as default };
